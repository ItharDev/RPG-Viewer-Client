Shader "Light2D/Sprites/Fast/LitPass3"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert(appdata_t IN)
			{
				...
				OUT.lightmap_uv = SL2D_FAST_LIGHTMAP_UV_3(OUT.worldPos);
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				spritePixel.rgb *= SL2D_FAST_PASS_LIT_3(IN.lightmap_uv) * spritePixel.a;
