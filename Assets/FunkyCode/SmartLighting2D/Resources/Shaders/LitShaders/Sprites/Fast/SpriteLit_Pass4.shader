Shader "Light2D/Sprites/Fast/LitPass4"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert(appdata_t IN)
			{
				...
				OUT.lightmap_uv = SL2D_FAST_LIGHTMAP_UV_4(OUT.worldPos);
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				spritePixel.rgb *= SL2D_FAST_PASS_LIT_4(IN.lightmap_uv) * spritePixel.a;
