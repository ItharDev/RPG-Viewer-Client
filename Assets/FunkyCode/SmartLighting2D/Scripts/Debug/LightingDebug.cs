...
namespace FunkyCode
{
    public class LightingDebug
    {
        ...
        static public void OnGUI()
        {
            if (lights == null)
            {
                lights = UnityEngine.Object.FindObjectsByType<Light2D>(FindObjectsSortMode.None);
                colliders = UnityEngine.Object.FindObjectsByType<LightCollider2D>(FindObjectsSortMode.None);
                sprites = UnityEngine.Object.FindObjectsByType<LightSprite2D>(FindObjectsSortMode.None);

                tilemaps = UnityEngine.Object.FindObjectsByType<LightTilemapCollider2D>(FindObjectsSortMode.None);
            }
