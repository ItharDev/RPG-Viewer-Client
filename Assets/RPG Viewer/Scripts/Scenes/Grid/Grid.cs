...
namespace RPG
{
    ...
    public class Grid : MonoBehaviour
    {
        ...
        public Cell PointToCell(Vector2 point)
        {
            ...
            {
                float distance = Vector2.Distance(point, Cells[i].worldPosition);
        ...
        {
            var cell = Cells.FirstOrDefault(x => x.gridPosition == new Vector2Int(column, row));
            return cell;
        }
        ...
        // TODO: 
        public MeasurementResult DistanceBetweenPoints(Vector2 start, Vector2 end)
        {
            float feet = 0;
